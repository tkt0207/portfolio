...
function Simple_radio(props) {
    ...
    //------------------------------------------------
    return(
        <div className='simple_radio_block'>
            {radio_list}
        </div>
    )
}

export default Simple_radio